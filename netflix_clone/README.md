...
1. Full desktop view of homepage
2. Hero section with featured content
3. Movie carousel sections
...
- **UI/UX Skills** — Modern, polished interface design
- **CSS Mastery** — Advanced styling techniques and responsive design
- **Attention to Detail** — Proper spacing, colors, and animations
- **Frontend Fundamentals** — HTML structure, CSS styling, JavaScript interactivity
- **Browser Compatibility** — Cross-browser CSS techniques
- **Accessibility** — Semantic HTML and readable typography

## 💡 Interview Tips
- Explain your design decisions (color choice, spacing, typography)
- Walk through responsive design approach
- Discuss CSS optimization (avoiding unnecessary classes)
- Show understanding of UX principles (hover states, loading states, etc)
- Mention potential for backend integration
